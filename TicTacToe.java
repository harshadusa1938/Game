...
/*  Author Name: -Harshadkumar N. Patel
                  Manoj S. Varma
                  Shashivardhan R. Reddy
    Description : Tic Toe Tac Game: There are two users, First one is Person and Second one is Computer, 
                  In the Tic Tac Game has a total 9box to playing around which are three row and 3 columns so that total 9 box to play.
                  First of all Person who choose the any box of row or columns and after finish the choosing by person then computer choose 
                  any box, then person will select the box then computer. They will play each other, whoever wins or Loss or Tie up. 
                  And got the message about that Wins, Loss or Tie Up Game. 
*/
...
public class TicTacToe extends JFrame implements ChangeListener, ActionListener 
{
  ...
  private Color oColor=Color.BLACK, xColor=Color.white;
  ...
  // Initialize
  public TicTacToe() {
    super("Tic Tac Toe Game By Harshad, Manoj, Shashivardhan");
   ...
   // g2d.setPaint(Color.PINK);
    //
    topPanel.add(new JLabel("::Select for Thickness::"));
  ...
  private class Board extends JPanel implements MouseListener {
    ...
    void newGame(char winner) {
      ...
      if (JOptionPane.showConfirmDialog(null, 
          ...
          +"Wanna play again ?", result, JOptionPane.YES_NO_OPTION)
